<div id="explain">
    <p class="grey">For any requests or questions, use the form below.</p>
    <p class="grey">If you have any sugestions for the game, you can also use this form.</p>
</div>
...
$destinataire = 'contact@themothmanprophecies.eu, lemondeoqp@gmail.com';
...
if (($err_formulaire) || (!isset($_POST['envoi'])))
{
    ?>
        ...
        <form action="page_contact.php" method="post">
            ...
            <div class="barre">
                <label for="object">Object* </label><input type="text" id="object" name="object"/>
            </div>
            <div class="barre">
