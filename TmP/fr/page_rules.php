...
<html>
    ...
    <body marginheight="0" >
        ...
        <div id="rules">
            ...
            <div class="contain">
                <div class="center">
                    <div class="tete"><h1>Réglement</h1></div>
                    <div class="corps"><?php require "rules.php" ?></div>
                    <div class="pied"><h2 class="grey">L'ignorance de ce réglement n'est pas une excuse</h2></div>
                </div>
            </div>
        </div>
